...
def test_get_all_appointments_for_doctor(client, monkeypatch, headers):
    ...
    monkeypatch.setattr('app.routes.get_all_appointments.get_doctor_id', mock_get_doctor_id)
